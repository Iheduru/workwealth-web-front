          ...
          <header className="h-16 border-b flex items-center justify-between px-4">
            ...
            <div className="flex items-center">
              ...
              <div className="flex ml-4 items-center">
                <div className="h-8 w-8 rounded-full bg-ww-purple-700 flex items-center justify-center text-white font-medium">
                  JO
                </div>
                <div className="ml-2">
                  <div className="text-sm font-medium">John Okafor</div>
